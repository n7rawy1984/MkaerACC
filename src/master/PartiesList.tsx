...
export function PartiesList() {
  ...
  const refreshParties = () => { setEditing(null); setStatusTarget(null); void master.refreshParties(); };
  ...
  return <>
    <div className="mt-4 flex flex-wrap gap-2">
      ...
      <button type="button" className={button} disabled={phase === "PENDING"} onClick={refreshParties}>{t("supplierMutation.refresh")}</button>
    </div>
