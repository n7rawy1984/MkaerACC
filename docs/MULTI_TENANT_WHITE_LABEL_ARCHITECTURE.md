...
- Company-scoped master, authorization, expense, Supplier Payment, Custody Advance, Settlement, Cash Return, journal, and command schemas.
...
- Company-aware P5A–P5E accounting commands and idempotency, including pooled company/Custodian balance enforcement and no-GL Settlement grouping.
