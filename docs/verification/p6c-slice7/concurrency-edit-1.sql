...
with changed as (update public.companies set legal_name='Editor 1' where id='77100000-0000-4000-8000-0000000000a1' and updated_at='2000-01-01T00:00:00.123456Z'::timestamptz returning id)
