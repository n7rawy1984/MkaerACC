...
begin
  ...
  if (select count(*) from public.projects where id='72000000-0000-4000-8000-0000000000c1' and company_id='72000000-0000-4000-8000-0000000000a1' and code='P6C-S2-PROJECT') <> 1 then raise exception 'Project mismatch'; end if;
  update public.project_assignments set status='INACTIVE'
    where id='72000000-0000-4000-8000-0000000000d1' and company_id='72000000-0000-4000-8000-0000000000a1' and project_id='72000000-0000-4000-8000-0000000000c1' and user_id='74e36291-172a-44e7-95be-f6c1283c315b';
  get diagnostics n = row_count;
  if n <> 1 then raise exception 'Expected exactly one synthetic assignment'; end if;
end;
$guard$;
commit;
