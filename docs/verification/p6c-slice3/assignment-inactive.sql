...
begin
  ...
  if (select count(*) from public.projects where id='73000000-0000-4000-8000-0000000000c1' and company_id='73000000-0000-4000-8000-0000000000a1' and code='P6C-S3-PROJECT')<>1 then raise exception 'Project mismatch'; end if;
  update public.project_assignments set status='INACTIVE' where id='73000000-0000-4000-8000-0000000000d1' and company_id='73000000-0000-4000-8000-0000000000a1' and project_id='73000000-0000-4000-8000-0000000000c1' and user_id='dc9ad1f5-804d-4f33-ab65-5e796fec0616';
  get diagnostics n = row_count;
  if n<>1 then raise exception 'Expected exactly one Alpha assignment'; end if;
end;
$guard$;
commit;
