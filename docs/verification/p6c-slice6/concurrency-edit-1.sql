...
with changed as (update public.parties set name='Editor 1' where company_id='76100000-0000-4000-8000-0000000000a1' and id='76100000-0000-4000-8000-0000000000f1' and type='SUPPLIER' and updated_at='2000-01-01T00:00:00Z'::timestamptz returning id) select set_config('makeracc.test_rows',count(*)::text,true) from changed;
select pg_sleep(4);
