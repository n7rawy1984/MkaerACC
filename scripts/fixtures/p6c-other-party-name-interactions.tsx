...
const parties=Array.from({length:12},(_,i)=>({...audit,id:`party-${i}`,company_id:'company-a',code:`00${i}`,name:`Party ${i}`,type:'OTHER',trn:'00123',contact_person:null,phone:null,email:null,address:null,notes:'Notes',status:i===11?'INACTIVE':'ACTIVE'}));
...
window.slice11={log,companies,parties,
