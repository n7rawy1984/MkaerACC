...
const { SubcontractsList } = moduleAt('src/master/SubcontractsList.tsx',{ '../i18n/I18nContext':{useT:()=>key=>key} });
...
const display=(parties)=>renderToStaticMarkup(createElement(SubcontractsList,{subcontracts:[historicContract],projects:[],parties}));
...
assert(!/<(?:button|input|form)\b/.test(after));
