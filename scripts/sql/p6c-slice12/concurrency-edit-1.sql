...
with changed as (update public.parties set name='Editor 1' where company_id='82100000-0000-4000-8000-0000000000a1' and id='82100000-0000-4000-8000-0000000000b1' and updated_at='2000-01-01T00:00:00.123456Z' returning id)
