...
- **P6D — Financial Flow Cutover (IN PROGRESS):** Expense READ, Treasury-funded Expense POST and Expense Reversal COMPLETE for Development within the accepted focused evidence in `docs/P6D_EXPENSE_REVERSAL.md`; operator smoke deferred/non-blocking. Corrected replacement and all other financial workflows NOT STARTED; no hybrid financial writes.
