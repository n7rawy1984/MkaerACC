...
- **P6D — Financial Flow Cutover (IN PROGRESS):** Checkpoints 1–6 COMPLETE for Development: Expense READ, Treasury-funded Expense POST, Expense Reversal, Supplier Payment, Supplier Credit Expense POST, and Subcontractor Advance READ/POST/Reversal. Checkpoint 6 reuses canonical P5F commands with authoritative readback and unchanged accounting/RLS; see `docs/P6D_SUBCONTRACTOR_ADVANCE.md`. Operator smoke is deferred/non-blocking. Certificates, Subcontractor Payments, Retention flows, Corrected Replacement Expense, and all other financial workflows remain NOT STARTED; no hybrid financial writes.
