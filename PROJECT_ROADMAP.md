...
- **P6D — Financial Flow Cutover (IN PROGRESS):** Expense READ, Treasury-funded Expense POST, Expense Reversal, and Supplier Payment COMPLETE for Development within the accepted focused evidence in `docs/P6D_SUPPLIER_PAYMENT.md`; operator smoke deferred/non-blocking. Corrected replacement and all other financial workflows NOT STARTED; no hybrid financial writes.
