...
- **P6D — Financial Flow Cutover (IN PROGRESS):** Expense READ COMPLETE for Development. Checkpoint 2 Treasury-funded Expense POST COMPLETE for Development within the accepted focused evidence recorded in `docs/P6D_TREASURY_EXPENSE_POST.md`; operator smoke deferred/non-blocking. Reversal and all other financial workflows NOT STARTED; no hybrid financial writes.
