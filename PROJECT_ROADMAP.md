...
- **P6D — Financial Flow Cutover (IN PROGRESS):** Checkpoints 1–8 COMPLETE for Development: Expense READ, Treasury-funded Expense POST, Expense Reversal, Supplier Payment, Supplier Credit Expense POST, Subcontractor Advance, Subcontractor Certificates, and Subcontractor Payment READ/POST/Reversal. Checkpoint 8 reuses canonical P5H commands and unchanged accounting/RLS/locking/dependency rules; see `docs/P6D_SUBCONTRACTOR_PAYMENTS.md`. Focused automated and rollback-only Development evidence passes; no migration. Operator smoke is deferred/non-blocking. Retention flows, Corrected Replacement Expense, and all other financial workflows remain NOT STARTED in P6D; no hybrid financial writes.
