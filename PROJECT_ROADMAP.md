...
- **P6D — Financial Flow Cutover (IN PROGRESS):** Checkpoints 1–7 COMPLETE for Development: Expense READ, Treasury-funded Expense POST, Expense Reversal, Supplier Payment, Supplier Credit Expense POST, Subcontractor Advance, and Subcontractor Certificate READ/draft/approve-post/reversal. Checkpoint 7 reuses canonical P5G commands, server-owned calculations and unchanged accounting/RLS/dependency rules; see `docs/P6D_SUBCONTRACTOR_CERTIFICATES.md`. Operator smoke is deferred/non-blocking. Subcontractor Payments, Retention flows, Corrected Replacement Expense, and all other financial workflows remain NOT STARTED in P6D; no hybrid financial writes.
